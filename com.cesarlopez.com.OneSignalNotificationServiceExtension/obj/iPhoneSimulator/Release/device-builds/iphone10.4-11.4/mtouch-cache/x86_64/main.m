...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "com.cesarlopez.com.OneSignalNotificationServiceExtension.dll";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
...
int main (int argc, char **argv)
{
	...
	argv [0] = (char *) "com.cesarlopez.com.OneSignalNotificationServiceExtension";
